...
// Cambiar a false para desactivar debug
const DEBUG: bool = false;

// Macro de debug centralizado
macro_rules! debug {
    ($($arg:tt)*) => {
        if DEBUG {
            eprintln!($($arg)*);
...
pub fn run_tracer(verbose: bool, step: bool, prog_and_args: Vec<String>) {
    ...
    match unsafe { fork() } {
        ...
        Ok(ForkResult::Parent { child }) => {
            ...
            vec_counts.sort_by(|a, b| b.1.cmp(&a.1));
